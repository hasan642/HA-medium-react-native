...
export { default as UpdateProfileScreen } from './update-profile/update-profile';
export { default as LanguageSwitcherScreen } from './language-switcher-screen/language-switcher-screen';